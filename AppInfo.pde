...
void processWidgetInfo(Widget w){
  ...
  //TODO
    ...
    if(currentProfile.getMedia(0).equals("None")){
      ...
      if (language.equals("Español")){
       text("Inicia sesión en Twitter primero en Configuración.", w.x+(w.sizeX/2), w.y+(w.sizeY/2));
      }
      else{
    ...
    if(currentProfile.getMedia(1).equals("None")){
      ...
      if (language.equals("Español")){
       text("Inicia sesión en Instagram primero en Configuración.", w.x+(w.sizeX/2), w.y+(w.sizeY/2));
      }
      else{
    ...
    if(currentProfile.getMedia(2).equals("None")){
      ...
      if (language.equals("Español")){
       text("Inicia sesión en Facebook primero en Configuración.", w.x+(w.sizeX/2), w.y+(w.sizeY/2));
      }
      else{
